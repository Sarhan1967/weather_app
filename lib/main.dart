    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: BlocProvider(
          ...
          // SearchPage Wrapped by above BlocProvider-----
            child: SearchPage(),
        )
      )
    );
      ...
      BlocBuilder<WeatherBloc, WeatherState>(
        builder: (context, state){
          if(state is WeatherIsNotSearched)
            // Container Wrapped by above BlocBuilder-----
            return Container(
                padding: EdgeInsets.only(left: 32, right: 32, ),
                child: Column(
                  children: <Widget>[
                    Text("Search Weather", style: TextStyle(fontSize: 30, fontWeight: FontWeight.w500, color: Colors.white70  ),),
